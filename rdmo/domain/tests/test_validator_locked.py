...
def test_create_no_parent(db):
    AttributeLockedValidator()({'uri_prefix': settings.DEFAULT_URI_PREFIX, 'key': 'test'})
...
def test_update(db):
    ...
    AttributeLockedValidator(attribute)(
        {'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent}
    )
...
def test_update_error(db):
    ...
    with pytest.raises(ValidationError):
        AttributeLockedValidator(attribute)(
            {'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent, 'locked': True}
        )
...
def test_update_unlock(db):
    ...
    AttributeLockedValidator(attribute)(
        {'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent, 'locked': False}
    )
...
def test_serializer_create_no_parent(db):
    ...
    validator({'uri_prefix': settings.DEFAULT_URI_PREFIX, 'key': 'test'})
...
def test_serializer_create_error(db):
    ...
    with pytest.raises(RestFameworkValidationError):
        validator({'uri_prefix': settings.DEFAULT_URI_PREFIX, 'key': 'test', 'parent': locked_attribute})
...
def test_serializer_update(db):
    ...
    validator({'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent})
...
def test_serializer_update_lock(db):
    ...
    validator({'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent, 'locked': True})
...
def test_serializer_update_unlock(db):
    ...
    validator({'uri_prefix': attribute.uri_prefix, 'key': attribute.key, 'parent': attribute.parent, 'locked': False})
