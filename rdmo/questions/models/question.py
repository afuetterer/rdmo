...
class Question(Model, TranslationMixin):
    ...
    uri_prefix = models.URLField(
        max_length=256, verbose_name=_('URI Prefix'), help_text=_('The prefix for the URI of this question.')
    )
    ...
    locked = models.BooleanField(
        default=False, verbose_name=_('Locked'), help_text=_('Designates whether this question can be changed.')
    )
    ...
    is_collection = models.BooleanField(
        default=False, verbose_name=_('is collection'), help_text=_('Designates whether this question is a collection.')
    )
    is_optional = models.BooleanField(
        default=False, verbose_name=_('is optional'), help_text=_('Designates whether this question is optional.')
    )
    order = models.IntegerField(
        default=0, verbose_name=_('Order'), help_text=_('The position of this question in lists.')
    )
    ...
    widget_type = models.CharField(
        max_length=16, verbose_name=_('Widget type'), help_text=_('Type of widget for this question.')
    )
    ...
    minimum = models.FloatField(
        null=True, blank=True, verbose_name=_('Minimum'), help_text=_('Minimal value for this question.')
    )
    maximum = models.FloatField(
        null=True, blank=True, verbose_name=_('Maximum'), help_text=_('Maximum value for this question.')
    )
    ...
    def copy(self, uri_prefix, key, questionset=None):
        question = copy_model(
            self, uri_prefix=uri_prefix, key=key, questionset=questionset or self.questionset, attribute=self.attribute
        )
