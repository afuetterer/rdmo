...
def test_unique_uri_validator_create(db):
    QuestionUniqueURIValidator()(
        {'uri_prefix': settings.DEFAULT_URI_PREFIX, 'key': 'test', 'questionset': QuestionSet.objects.first()}
    )
...
def test_unique_uri_validator_update(db):
    ...
    QuestionUniqueURIValidator(question)(
        {'uri_prefix': question.uri_prefix, 'key': question.key, 'questionset': question.questionset}
    )
...
def test_unique_uri_validator_serializer_create(db):
    ...
    validator({'uri_prefix': settings.DEFAULT_URI_PREFIX, 'key': 'test', 'questionset': QuestionSet.objects.first()})
...
def test_unique_uri_validator_serializer_update(db):
    ...
    validator({'uri_prefix': question.uri_prefix, 'key': question.key, 'questionset': question.questionset})
