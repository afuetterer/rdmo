...
urlpatterns = [
    ...
    re_path(
        r'^(?P<pk>[0-9]+)/update/information/$',
        ProjectUpdateInformationView.as_view(),
        name='project_update_information',
    ),
    ...
    re_path(
        r'^(?P<pk>[0-9]+)/import/(?P<format>[a-z-]+)/$', ProjectUpdateImportView.as_view(), name='project_update_import'
    ),
    re_path(r'^(?P<project_id>[0-9]+)/memberships/create/$', MembershipCreateView.as_view(), name='membership_create'),
    re_path(
        r'^(?P<project_id>[0-9]+)/memberships/(?P<pk>[0-9]+)/update/$',
        MembershipUpdateView.as_view(),
        name='membership_update',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/memberships/(?P<pk>[0-9]+)/delete/$',
        MembershipDeleteView.as_view(),
        name='membership_delete',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/invite/(?P<pk>[0-9]+)/delete/$', InviteDeleteView.as_view(), name='invite_delete'
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/integrations/create/(?P<provider_key>[a-z]+)/$',
        IntegrationCreateView.as_view(),
        name='integration_create',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/integrations/(?P<pk>[0-9]+)/update/$',
        IntegrationUpdateView.as_view(),
        name='integration_update',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/integrations/(?P<pk>[0-9]+)/delete/$',
        IntegrationDeleteView.as_view(),
        name='integration_delete',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/integrations/(?P<pk>[0-9]+)/webhook/$',
    ...
    re_path(
        r'^(?P<project_id>[0-9]+)/snapshots/(?P<pk>[0-9]+)/update/$',
        SnapshotUpdateView.as_view(),
        name='snapshot_update',
    ),
    re_path(
        r'^(?P<project_id>[0-9]+)/snapshots/(?P<pk>[0-9]+)/rollback/$',
        SnapshotRollbackView.as_view(),
        name='snapshot_rollback',
    ),
    re_path(r'^(?P<pk>[0-9]+)/answers/$', ProjectAnswersView.as_view(), name='project_answers'),
    re_path(
        r'^(?P<pk>[0-9]+)/answers/export/(?P<format>[a-z]+)/$',
        ProjectAnswersExportView.as_view(),
        name='project_answers_export',
    ),
    re_path(
        r'^(?P<pk>[0-9]+)/snapshots/(?P<snapshot_id>[0-9]+)/answers/$',
        ProjectAnswersView.as_view(),
        name='project_answers',
    ),
    re_path(
        r'^(?P<pk>[0-9]+)/snapshots/(?P<snapshot_id>[0-9]+)/answers/export/(?P<format>[a-z]+)/$',
        ProjectAnswersExportView.as_view(),
        name='project_answers_export',
    ),
    re_path(r'^(?P<pk>[0-9]+)/views/(?P<view_id>[0-9]+)/$', ProjectViewView.as_view(), name='project_view'),
    re_path(
        r'^(?P<pk>[0-9]+)/views/(?P<view_id>[0-9]+)/export/(?P<format>[a-z]+)/$',
        ProjectViewExportView.as_view(),
        name='project_view_export',
    ),
    re_path(
        r'^(?P<pk>[0-9]+)/snapshots/(?P<snapshot_id>[0-9]+)/views/(?P<view_id>[0-9]+)/$',
        ProjectViewView.as_view(),
        name='project_view',
    ),
    re_path(
        r'^(?P<pk>[0-9]+)/snapshots/(?P<snapshot_id>[0-9]+)/views/(?P<view_id>[0-9]+)/export/(?P<format>[a-z]+)/$',
        ProjectViewExportView.as_view(),
        name='project_view_export',
    ),
