...
PROJECT_ISSUE_PROVIDERS = [('github', _('GitHub'), 'rdmo.projects.providers.GitHubIssueProvider')]

GITHUB_PROVIDER = {'client_id': '', 'client_secret': ''}
...
LOGGING = {
    ...
    'formatters': {
        ...
        'fullverbose': {'format': '%(asctime)s [%(levelname)s] %(pathname)s %(lineno)d: %(message)s'},
    },
    'handlers': {
        'mail_admins': {
            'level': 'ERROR',
    ...
    'loggers': {
        ...
        'django.request': {'handlers': ['mail_admins', 'error_log'], 'level': 'ERROR', 'propagate': True},
        'rdmo': {'handlers': ['rdmo_log'], 'level': 'DEBUG', 'propagate': False},
    },
}
